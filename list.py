...
def print_user_list():
    ...
    print(f'{log.default}176.) {log.reset}List this user\'s GenericWrite privileges')
    print(f'{log.default}177.) {log.reset}List this user\'s description')
    print(f'{log.default}178.) {log.reset}List this user\'s email')
    print(f'{log.default}179.) {log.reset}List this user\'s group memberships')
    print(f'{log.default}180.) {log.reset}List if this user\'s AS-REP roastable')
    print(f'{log.default}181.) {log.reset}List if this user\'s kerberoastable')
...
def print_group_list():
    ...
    print(f'{log.default}215.) {log.reset}List this group\'s GenericWrite privileges')
    print(f'{log.default}216.) {log.reset}List this group\'s description')
    print(f'{log.default}217.) {log.reset}List this group\'s group memberships')
    print(f'{log.default}218.) {log.reset}List this group\'s members')
...
def print_computer_list():
    ...
    print(f'{log.default}250.) {log.reset}List this computer\'s GenericWrite privileges')
    print(f'{log.default}251.) {log.reset}List this computer\'s group memberships')
