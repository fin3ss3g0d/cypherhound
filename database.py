...
class Driver:
    ...
    def __init__(self, user, password, db, u_search="", g_search="", c_search="", regex=""):
        try:
            ...
            self.queries = {
                '1': {
                    'query': 'MATCH (n:User {hasspn: true}) RETURN n.name AS result ORDER BY n.name',
                ...
                '2': {
                    'query': 'MATCH (n:User {owned: true, hasspn: true}) RETURN n.name AS result ORDER BY n.name',
                ...
                '6': {
                    'query': 'MATCH p=(m:Group)-[:MemberOf]->(g:Group)-[:CanRDP]->(n:Computer) WHERE (m.objectid =~ "(?i)S-1-5-21-.*-513" OR m.objectid =~ "(?i).*-S-1-5-11" OR m.objectid =~ "(?i).*-S-1-1-0" OR m.objectid =~ "(?i).*-S-1-5-32-545") RETURN m.name,n.name,g.name ORDER BY m.name',
                    'desc': 'List all group-delegated RDP privileges for Users, Domain Users, Authenticated Users, or Everyone groups',
                    'message_generator': lambda r: (r.get('m.name') is not None and r.get('n.name') is not None and r.get('g.name') is not None) and f'{log.default}Group {log.reset}{log.red}{r["m.name"]}{log.reset}{log.default} is MemberOf {log.reset}{log.red}{r["g.name"]} {log.reset}{log.default}which CanRDP to {log.reset}{log.red}{r["n.name"]}{log.reset}' or None,
                    'handler': self.handle_standard_query,
                    'type': 'general',
                },
                '7': {
                ...
                '8': {
                    'query': 'MATCH (n {owned: true})-[:MemberOf]->(g:Group)-[:CanRDP]->(m:Computer) RETURN n.name,labels(n),m.name,g.name ORDER BY n.name',
                    'desc': 'List all group-delegated RDP privileges for owned principals',
                    'message_generator': lambda r: (r.get('m.name') is not None and r.get('n.name') is not None and r.get('g.name') is not None) and f'{log.red}{r["n.name"]} {log.reset}{log.default}({r["labels(n)"][0]}/{r["labels(n)"][1]}){log.reset}{log.default} is MemberOf {log.reset}{log.red}{r["g.name"]} {log.reset}{log.default}which CanRDP to {log.reset}{log.red}{r["m.name"]}{log.reset}' or None,
                    'handler': self.handle_standard_query,
                    'type': 'general',
                },                                
                '9': {
                ...
                '13': {
                    'query': 'MATCH p=shortestPath((m:User)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)admin|adm).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '14': {
                    'query': 'MATCH p=shortestPath((m:Group)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)admin|adm).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '15': {
                    'query': 'MATCH p=shortestPath((m:Computer)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)admin|adm).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '17': {
                    'query': 'MATCH p=shortestPath((m {owned: true})-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)admin|adm).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '21': {
                    'query': 'MATCH p=shortestPath((m:User)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)SQL).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '22': {
                    'query': 'MATCH p=shortestPath((m:Group)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)SQL).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '23': {
                    'query': 'MATCH p=shortestPath((m:Computer)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)SQL).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '25': {
                    'query': 'MATCH p=shortestPath((m {owned: true})-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)SQL).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '28': {
                    'query': 'MATCH p=shortestPath((m:User)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)service|svc).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '29': {
                    'query': 'MATCH p=shortestPath((m:Group)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)service|svc).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '30': {
                    'query': 'MATCH p=shortestPath((m:Computer)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)service|svc).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '32': {
                    'query': 'MATCH p=shortestPath((m {owned: true})-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)service|svc).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '36': {
                    'query': 'MATCH p=shortestPath((m:User)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)WEB).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '37': {
                    'query': 'MATCH p=shortestPath((m:Group)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)WEB).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '38': {
                    'query': 'MATCH p=shortestPath((m:Computer)-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)WEB).*" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '40': {
                    'query': 'MATCH p=shortestPath((m {owned: true})-[r*1..]->(n:Group)) WHERE n.name =~ ".*((?i)WEB).*" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '48': {
                    'query': 'MATCH p=shortestPath((m:User)-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-512" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '49': {
                    'query': 'MATCH p=shortestPath((m:Group)-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-512" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '50': {
                    'query': 'MATCH p=shortestPath((m:Computer)-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-512" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '52': {
                    'query': 'MATCH p=shortestPath((m {owned: true})-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-512" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '54': {
                    'query': 'MATCH p=shortestPath((m:User)-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-519" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '55': {
                    'query': 'MATCH p=shortestPath((m:Group)-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-519" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '56': {
                    'query': 'MATCH p=shortestPath((m:Computer)-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-519" AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '58': {
                    'query': 'MATCH p=shortestPath((m {owned: true})-[r*1..]->(n:Group)) WHERE n.objectid =~ "(?i)S-1-5-21-.*-519" AND NOT m=n AND NONE (r IN relationships(p) WHERE type(r)= "GetChanges") AND NONE (r in relationships(p) WHERE type(r)="GetChangesAll") AND NONE (r in relationships(p) WHERE type(r)="GetChangesInFilteredSet") RETURN m.name,p ORDER BY m.name',
                ...
                '60': {
                    'query': 'MATCH p=(m:Computer)-[r:HasSession]->(n:User {owned: true}) RETURN n.name,m.name ORDER BY n.name',
                ...
                '62': {
                    'query': 'MATCH (u:User {dontreqpreauth: true, owned: true}) RETURN u.name ORDER BY u.name',
                ...
                '87': {
                    'query': 'MATCH (m)-[:AdminTo]->(n:Computer)-[:MemberOf]->(g:Group) WHERE g.objectid =~ "(?i)S-1-5-21-.*-516" RETURN m.name,n.name,labels(m) ORDER BY m.name',
                    'desc': 'List all AdminTo privileges to Domain Controllers',
                    'message_generator': lambda r: (r.get('n.name') is not None and r.get('m.name') is not None) and f'{log.red}{r["m.name"]} {log.reset}{log.default}({r["labels(m)"][0]}/{r["labels(m)"][1]}){log.reset}{log.default} is AdminTo {log.reset}{log.red}{r["n.name"]}{log.reset}' or None,
                    'handler': self.handle_standard_query,
                    'type': 'general',
                },
                '88': {
                ...
                '154': {
                    'query': 'MATCH p=(n:User)-[r:DCSync]->(m:Domain) WHERE n.domain <> m.name RETURN n.name,m.name ORDER BY n.name',
                ...
                '155': {
                    'query': 'MATCH p=(n:Group)-[r:DCSync]->(m:Domain) WHERE n.domain <> m.name RETURN n.name,m.name ORDER BY n.name',
                ...
                '156': {
                    'query': 'MATCH p=(n:Computer)-[r:DCSync]->(m:Domain) WHERE n.domain <> m.name RETURN n.name,m.name ORDER BY n.name',
                ...
                '157': {
                    'query': 'MATCH p=(n:Domain)-[r:DCSync]->(m:Domain) WHERE n.name <> m.name RETURN n.name,m.name ORDER BY n.name',
                    'desc': 'List all domain cross-domain DCSync privileges',
                    'message_generator': lambda r: (r.get('n.name') is not None) and f'{log.default}Domain {log.reset}{log.red}{r["n.name"]}{log.reset}{log.default} has DCSync privileges for {log.reset}{log.red}{r["m.name"]}{log.reset}' or None,
                    'handler': self.handle_standard_query,
                    'type': 'general',
                },
                '158': {
